function EndScreen(props: { setShowWelcomeSite: Function }) {
  return (
    <>
      <div className="text-center mt-36 lg:mt-56 ">
        <h1 className="text-5xl lg:text-[12rem] font-bold font-mono leading-[0.7]">xxxxxx</h1>
      ...
      <div className="lg:inline mx-auto">
        ...
        <button className="block mt-28 mx-auto text-2xl lg:text-4xl border-black border-2 rounded-lg py-4 px-14 hover:scale-110 duration-200" onClick={() => props.setShowWelcomeSite(true)}>Hrát znovu</button>
      </div>
    </>
  );
}
