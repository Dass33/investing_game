  ...
  return (
    <>
      ...
      <div className="lg:inline mx-auto">
        <img src="../dist/assets/react.svg" alt="placeholder" className="h-44 block lg:pl-20 lg:inline mx-auto lg:float-start text-center  my-20 lg:my-0 lg:mb-40"></img>
        <img src="../dist/assets/react.svg" alt="placeholder" className="h-44 hidden lg:pr-20 lg:inline lg:float-right text-center lg:mb-40"></img>
