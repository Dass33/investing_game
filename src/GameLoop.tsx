  ...
  return (
    <>
      <div className="mt-8">
        ...
        <img src={`../dist/assets/events/${eventData[eventIndex].IMG}.png`}></img>
        ...
        return (
          <div className="mt-3 mx-6 flex justify-between" key={item.productName}>
            <h3 className="text-3xl flex-1 break-words">{item.productName}
              {diceIncome > 0 && <img className="size-8 mb-1 inline-block" src={`../dist/assets/dices/dice${diceRoll}.svg`}></img>}
            </h3>
