...
function App() {
    ...
    return (
        <>
            {showWelcomeSite && <WelcomeSite setShowWelcomeSite={setShowWelcomeSite} gameMode={gameMode} setGameMode={setGameMode} />}
            {!showWelcomeSite && !endGame && <GameLoop SetEndGame={setEndGame} year={year} setYear={setYear} setTotalScore={setTotalScore} gameMode={gameMode} />}
